...
"" + null = ${""+null} <br>   
""-1 = ${""-1} <br> 
empty null=${empty null} <br> <!-- empty 는 null 이나 빈 컬렉션 배열일 때 true -->
empty list=${empty list} <br>
null==0 = ${null==0} <br>
null eq 0 = ${null eq 0} <br>
name == "남궁성"=${name=="남궁성"} <br>
name != "남궁성"=${name!="남궁성"} <br>
name eq "남궁성"=${name eq "남궁성"} <br>  <!-- eq : == -->
name ne "남궁성"=${name ne "남궁성"} <br>  <!-- ne : != -->
