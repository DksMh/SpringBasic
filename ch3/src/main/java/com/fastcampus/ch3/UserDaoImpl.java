...
//        PreparedStatement pstmt = null;
        ...
        // jdk7 부터 try - with - resources 를 사용할 수 있어서, finally block 안에서 일일히 자원을 반환하지 않아도 자원이 알아서 반환되게 할 수 있다
        // AutoCloseable을 구현한 클래스들에 한해서 try - with - resources 를 사용할 수 있다
        try (
